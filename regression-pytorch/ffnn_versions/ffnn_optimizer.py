...
propertyRangeList = ["SGD", "SGD with Momentum", "Adam", "AdamW", "RMSprop", "Adagrad"]
propertyAppend = []
for changingProperty in propertyRangeList:
    ...
    if run_mode == 1 or run_mode == 2:
        ...
        if changingProperty == "SGD":
            optimizer = optim.SGD(model.parameters(), lr=0.001)
        elif changingProperty == "SGD with Momentum":
            optimizer = optim.SGD(model.parameters(), lr=0.001, momentum=0.9)
        elif changingProperty == "Adam":
            optimizer = optim.Adam(model.parameters(), lr=0.001)
        elif changingProperty == "AdamW":
            optimizer = optim.AdamW(model.parameters(), lr=0.001)
        elif changingProperty == "RMSprop":
            optimizer = optim.RMSprop(model.parameters(), lr=0.001, weight_decay=0.01)
        elif changingProperty == "Adagrad":
            optimizer = optim.Adagrad(model.parameters(), lr=0.001)
        elif changingProperty == "LBFGS":
...
with open(r".\EpochsData\optimizers_data.txt", "w") as f:
